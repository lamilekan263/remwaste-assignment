...
const SkipCard: React.FC<Props> = ({ skip, isSelected, handleSelectedSkip }) => {
    return (
        <div onClick={() => skip.allows_heavy_waste && handleSelectedSkip(skip)}
            className={`bg-neutral-800 rounded-lg p-6 capitalize border-1 ${isSelected ? 'border-blue-800' : 'border-neutral-900 hover:border-blue-700'}
            ${!skip.allows_heavy_waste ? 'opacity-50 cursor-not-allowed hover:border-neutral-900' : 'cursor-pointer '}
            `}>
            ...
            <div className='border-b pb-5'>
                ...
                <div className='flex flex-wrap gap-2'>
                    ...
                    {skip.allowed_on_road && <SkipBadge
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='my-4 flex flex-col items-end gap-1'>
                    <span className='text-xl font-bold text-blue-700'>£ {Math.floor(skip.price_before_vat + (skip.price_before_vat * skip.vat / 100))}</span>
